...
export default function Notifications() {
  ...
  const handleSend = async () => {
    ...
    for (let i = 0; i < employees.length; i++) {
      ...
      try {
        console.log("Отправка на:", emp.email, params);
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) => updateSettings({
                  ...
                  types: settings.types // сохраняем текущие типы
                })}
                className="input"
              >
                    ...
                    >
                      <input
                        ...
                        onChange={(e) => {
                          ...
                          updateSettings({
                            frequency: settings.frequency, // сохраняем текущую частоту
                            types: newTypes
                          });
                        }}
